...
```{r}
setwd("D:/Data")
Climate<-read.csv("Unit2/climate_change.csv",header = TRUE,stringsAsFactors = F,sep = ",")
...
```{r}
model_test<-predict(stepmodel,newdata=test)
SSE=sum((model_test-test$Temp)^2)
